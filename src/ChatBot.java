public class ChatBot {
    ...
    // constructor
    public ChatBot(String chatBotName, int faveNum, int age) {
        name = chatBotName;
        number = faveNum;
        ageNumber = age;
    }
    ...
    // method that prints hobbies
    public void hobby(){
        System.out.println("What hobbies do you like to do?");
        System.out.println("I like to draw, play games, and swim!");
    }

    // method that returns the difference in age
    public int age(int yourAge){
        return ageNumber - yourAge;
    }
